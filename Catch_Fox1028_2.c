...
void Information()
{
    ...
    printf("狸不动，游戏继续。一次游戏中只有10次机会！要把握机会呀！\n");
   	printf("请在以下两个模式中选择一个（直接输入1或2）： \n");
	printf("模式1：若四洞直线排列，则洞组成一个线段，分别为： \n");
	printf("+-----+  +-----+  +-----+  +-----+ \n");
	printf("|     |  |     |  |     |  |     | \n");
	printf("|  1  |  |  2  |  |  3  |  |  4  | \n");
	printf("|     |  |     |  |     |  |     | \n");
	printf("+-----+  +-----+  +-----+  +-----+ \n");
    printf("模式2：若四洞环状排列，则洞组成一个环形，分别为： \n");
	printf("+-----+  +-----+ \n");
	printf("|     |  |     | \n");
	printf("|  1  |  |  2  | \n");
	printf("|     |  |     | \n");
...
/*-------------main loop------------*/
	...
	/*---------timer-----------*/
			...
			else
			{
				...
				printf("Debe introducir 1 o 2.\n");
				printf("If you still enter other characters, you'll regret it!!! \n");
				//continue;
				//scanf("%d",&pattern);
				//return 0;
			}
